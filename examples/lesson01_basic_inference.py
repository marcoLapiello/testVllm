...
def main():
    ...
    print("Model: cpatonn/granite-4.0-h-small-AWQ-4bit (32B AWQ-4bit quantized)")
    print()
    ...
    llm = LLM(
        model="cpatonn/granite-4.0-h-small-AWQ-4bit",  # IBM Granite 4.0 32B AWQ-4bit quantized
